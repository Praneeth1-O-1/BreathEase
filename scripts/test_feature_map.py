...
with torch.no_grad():
    output = model(waveforms, return_features=True)

print("Feature Map :", output["feature_map"].shape)
print("Embedding   :", output["embedding"].shape)
print("Clip Output :", output["clipwise_output"].shape) 